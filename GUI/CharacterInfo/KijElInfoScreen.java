...
public class KijElInfoScreen extends JPanel {
    ...
    public KijElInfoScreen(GameGUI gui) {
        ...
        play.addActionListener(e -> {
            ...
            if (mode == BattleMode.PVP) {
                ...
                if (picking == 1) {
                    ...
                    // P2 picks KijEl — check not same as P1
        ...
        back = createButton();
        back.addActionListener(e -> { SoundManager.playSFX(SoundManager.SFX_BUTTON); gui.showScreen("SelectKijElScreen"); });
        this.add(back);
