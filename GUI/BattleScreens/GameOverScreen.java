...
public class GameOverScreen extends JPanel {
    ...
    // Battle arena background — same as the match screens.
    ...
    private Runnable onComplete; // fired when the animation finishes → GameGUI switches to PlayOrExitScreen
                ...
                case 2 -> {
                    ...
                    if (titleSettled && titleAlpha >= 1f) {
                        ...
                        Timer hold = new Timer(2200, ev -> {
                            animTimer.stop();
                            // Animation done — hand off to GameGUI which will
                            // card-switch to PlayOrExitScreen.
