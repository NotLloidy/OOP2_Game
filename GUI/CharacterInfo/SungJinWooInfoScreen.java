...
public class SungJinWooInfoScreen extends JPanel {
    ...
    public SungJinWooInfoScreen(GameGUI gui) {

        this.setLayout(null);

        bgImage = new ImageIcon("Assets/character_related/character_info/infoSungJinWoo.png").getImage();
        ...
        back = createButton();
        back.addActionListener(e -> { SoundManager.playSFX(SoundManager.SFX_BUTTON); gui.showScreen("SelectSungJinWooScreen"); });
        this.add(back);
