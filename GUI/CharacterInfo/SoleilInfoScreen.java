...
import Characters.SoleilMooncrest;
...
public class SoleilInfoScreen extends JPanel {
    ...
    public SoleilInfoScreen(GameGUI gui) {
        ...
        back = createButton();
        back.addActionListener(e -> { SoundManager.playSFX(SoundManager.SFX_BUTTON); gui.showScreen("SelectSoleilScreen"); });
        this.add(back);
